...
const ThingsToKnow = () => {
  return (
    <section className="things-section" id="things-to-know">
      ...
      <div className="things-grid">
        ...
        <div className="things-card">
          ...
          <div className="things-card-title">
            Cancellation policy
          </div>
